// iOS implementation - Expo Go compatible placeholder
...
// iOS implementation - Static map placeholder for Expo Go
export const PlatformMapView = forwardRef<any, MapComponentProps>((props, ref) => {
  ...
  const handleOpenMaps = () => {
    if (initialRegion) {
      const url = `https://maps.apple.com/?q=${initialRegion.latitude},${initialRegion.longitude}&z=14`;
      Linking.openURL(url);
    }
  };
...
// iOS implementation - Marker placeholder (not visible in static placeholder)
export function PlatformMarker(props: MarkerProps) {
  // In placeholder mode, markers are not rendered
  return null;
}

// iOS implementation - no provider needed
